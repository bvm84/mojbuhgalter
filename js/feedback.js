    ...
    form.onsubmit = async function(e) {
        ...
        try {
            ...
            if (res.ok) {
                ...
                msgBox.innerHTML = 'Спасибо! Запрос успешно отправлен. Я свяжусь с вами в ближайшее время.';
                form.reset(); 
            ...
            msgBox.style.display = 'block';
            msgBox.className = 'msg-error';
            msgBox.innerHTML = 'Произошла ошибка. Попробуйте позже или позвоните мне.';
        } finally {
